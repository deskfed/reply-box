// Generated on 2014-08-27 using generator-angular 0.7.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    yeoman: {
      ...
      demo: require('./bower.json').appPath || 'demo',
      dist: 'dist'
    },
    ...
    watch: {
      coffee: {
        files: [
          ...
          '<%= yeoman.demo %>/scripts/{,*/}*.{coffee,litcoffee,coffee.md}'
        ],
    ...
    compass: {
      options: {
        ...
        importPath: '<%= yeoman.demo %>/bower_components',
